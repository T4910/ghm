...
export default function ApplicationsPage() {
  ...
  const [examQuestions, setExamQuestions] = useState([
    ...
    {
      id: 5,
      question: "Are you willing to commit to regular meetings and activities?",
    },
  ]);
  ...
  const handleAddQuestion = () => {
    if (newQuestion.trim()) {
      setExamQuestions([
        ...examQuestions,
        { id: examQuestions.length + 1, question: newQuestion },
      ]);
      setNewQuestion("");
    }
  };
  ...
  const viewApplication = (application: undefined) => {
  ...
  const toggleExamInvitation = (applicationId: number) => {
    ...
    alert(
      `Exam invitation ${
        pendingApplications.find((a) => a.id === applicationId)?.examInvited
          ? "revoked"
          : "sent"
  ...
  const sendExamInvitation = () => {
    if (selectedApplication) {
      alert(
        `Exam invitation sent to ${selectedApplication.name} at ${selectedApplication.email}`
      );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Manage new member applications and entrance exams
        </p>
      </div>
                    ...
                    <TableRow key={application.id}>
                      ...
                      <TableCell>
                        <Switch
                          ...
                          onCheckedChange={() =>
                            toggleExamInvitation(application.id)
                          }
                        />
                      </TableCell>
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          <Button
                            ...
                            onClick={() =>
                              viewApplication(
                                application as unknown as undefined
                              )
                            }
                          >
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            disabled={application.examInvited}
                          >
                    ...
                    <TableRow key={application.id}>
                      ...
                      <TableCell className="text-right">
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            viewApplication(application as unknown as undefined)
                          }
                        >
        ...
        <TabsContent value="exam">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure questions for the entrance exam
              </CardDescription>
            </CardHeader>
        ...
        >
          <DialogContent className="max-w-3xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Review the application from {selectedApplication.name}
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 rounded-md border p-3 text-sm">
                    I am writing to express my interest in joining your esteemed
                    organization. As a student passionate about [specific
                    interest], I believe I can contribute significantly to the{" "}
                    {selectedApplication.subunit} subunit. I have experience in
                    [relevant skills] and I am eager to learn and grow with your
                    organization.
                  </p>
                </div>
              </div>
                ...
                <div className="mt-2 rounded-md border p-4">
                  {selectedApplication.examInvited ? (
                    selectedApplication.examScore !== undefined ? (
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          This applicant has completed the entrance examination
                          with a score of {selectedApplication.examScore}%.
                        </p>
                      </div>
                    ) : (
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          This applicant has been invited to take the entrance
                          examination.
                        </p>
                      </div>
                    )
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        This applicant has not yet been invited to take the
                        entrance examination.
                      </p>
                      <Button
                        className="mt-2"
                        size="sm"
                        onClick={sendExamInvitation}
                      >
